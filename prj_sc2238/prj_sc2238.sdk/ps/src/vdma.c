...
void vdma_init(unsigned int baseAddr, unsigned int imgAddr)
{
	...
	Xil_Out32(baseAddr+S2MM_FRMDLY_STRIDE_OFSET,0xf00);
	Xil_Out32(baseAddr+S2MM_HSIZE_OFSET,0xf00);
	Xil_Out32(baseAddr+S2MM_VSIZE_OFSET,0x21c);
...
void vdma_ImgCap_write_init(void)
{
	...
	unsigned int ImgCap1_Addr = 0x17200000;
	unsigned int ImgCap2_Addr = 0x17400000;

//	Xil_Out32(VDMA_IMGCAP0_BASE_ADDR+S2MM_VDMACR_OFSET,0x8b);
//	//Xil_Out32(VDMA0_BASE_ADDR+S2MM_VDMASR_OFSET,0x4990);
//	Xil_Out32(VDMA_IMGCAP0_BASE_ADDR+S2MM_START_ADDRESS1_OFSET,0x17000000);
...
//	Xil_Out32(VDMA_IMGCAP0_BASE_ADDR+S2MM_FRMDLY_STRIDE_OFSET,0xf00);
//	Xil_Out32(VDMA_IMGCAP0_BASE_ADDR+S2MM_HSIZE_OFSET,0xf00);
//	Xil_Out32(VDMA_IMGCAP0_BASE_ADDR+S2MM_VSIZE_OFSET,0x50);
...
void vdma_videoStr_write_init(void)
{
	...
	Xil_Out32(VDMA_VIDEOSTR_BASE_ADDR+S2MM_FRMDLY_STRIDE_OFSET,0xf00);
	Xil_Out32(VDMA_VIDEOSTR_BASE_ADDR+S2MM_HSIZE_OFSET,0xf00);
	Xil_Out32(VDMA_VIDEOSTR_BASE_ADDR+S2MM_VSIZE_OFSET,0x50);
