...
module bd_f60c
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_1_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_1_AXI, ADDR_WIDTH 9, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK0, DATA_WIDTH 32, FREQ_HZ 100000000, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 0, HAS_LOCK 0, HAS_PROT 1, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, MAX_BURST_LENGTH 1, NUM_READ_OUTSTANDING 2, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 2, NUM_WRITE_THREADS 1, PHASE 0.000, PROTOCOL AXI4LITE, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [8:0]SLOT_1_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_1_AXI AWADDR" *) input [8:0]SLOT_1_AXI_awaddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_3_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_3_AXI, ADDR_WIDTH 32, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK0, DATA_WIDTH 64, FREQ_HZ 100000000, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 0, HAS_LOCK 0, HAS_PROT 0, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 0, HAS_WSTRB 1, ID_WIDTH 0, MAX_BURST_LENGTH 8, NUM_READ_OUTSTANDING 2, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 2, NUM_WRITE_THREADS 1, PHASE 0.000, PROTOCOL AXI4, READ_WRITE_MODE WRITE_ONLY, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [31:0]SLOT_3_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 SLOT_4_AXIS TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_4_AXIS, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK0, FREQ_HZ 100000000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 1, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 1" *) input [31:0]SLOT_4_AXIS_tdata;
  ...
  wire [8:0]net_slot_1_axi_araddr;
  ...
  wire [8:0]net_slot_1_axi_awaddr;
  ...
  bd_f60c_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe55(net_slot_3_axi_ar_cnt),
        .probe56(net_slot_3_axi_araddr),
        .probe57(net_slot_3_axi_arlen),
        .probe58(net_slot_3_axi_arsize),
        .probe59(net_slot_3_axi_aw_cnt),
        .probe6(net_slot_0_axi_b_cnt),
        .probe60(net_slot_3_axi_awaddr),
        .probe61(net_slot_3_axi_awlen),
        .probe62(net_slot_3_axi_awsize),
        .probe63(net_slot_3_axi_b_cnt),
        .probe64(net_slot_3_axi_bresp),
        .probe65(net_slot_3_axi_r_cnt),
        .probe66(net_slot_3_axi_rdata),
        .probe67(net_slot_3_axi_wdata),
        .probe68(net_slot_3_axi_wstrb),
        .probe69(net_slot_3_axi_aw_ctrl),
        .probe7(net_slot_0_axi_bresp),
        .probe70(net_slot_3_axi_w_ctrl),
        .probe71(net_slot_3_axi_b_ctrl),
        .probe72(net_slot_3_axi_ar_ctrl),
        .probe73(net_slot_3_axi_r_ctrl),
        .probe74(net_slot_4_axis_tdata),
        .probe75(net_slot_4_axis_tkeep),
        .probe76(net_slot_4_axis_tuser),
        .probe77(net_slot_4_axis_tvalid),
        .probe78(net_slot_4_axis_tready),
        .probe79(net_slot_4_axis_tlast),
        .probe8(net_slot_0_axi_r_cnt),
        .probe80(net_slot_5_axis_tdata),
        .probe81(net_slot_5_axis_tkeep),
        .probe82(net_slot_5_axis_tuser),
        .probe83(net_slot_5_axis_tvalid),
        .probe84(net_slot_5_axis_tready),
        .probe85(net_slot_5_axis_tlast),
